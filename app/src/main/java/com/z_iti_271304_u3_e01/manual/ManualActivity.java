package com.z_iti_271304_u3_e01.manual;
...
import com.z_iti_271304_u3_e01.R;
...
public class ManualActivity extends AppCompatActivity {
            ...
            webSocketClient.setConnectionCallback(new ROSWebSocketClient.ConnectionCallback() {
                ...
                public void onConnectionSuccess() {
                    runOnUiThread(() -> {
                        ...
                        isConnecting = false;
                        Toast.makeText(ManualActivity.this, "Conectado al servidor", Toast.LENGTH_SHORT).show();
                    });
                }
    ...
    private void showReconnectionDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Reconectando");
        builder.setMessage("Intento " + reconnectAttempts + " de " + MAX_RECONNECT_ATTEMPTS);
        builder.setCancelable(false);
    ...
    private void showFinalConnectionError() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Error de Conexión");
        builder.setMessage("No se pudo establecer la conexión con el servidor después de varios intentos.");
